...
void LCD_show_UI10(void)
{
	...
	{
		OLED_Clear();
		OLED_ShowImage(30,10+i,16,16,Eyebrow[0]);//◊Û√º√´
		OLED_ShowImage(82,10+i,16,16,Eyebrow[1]);//”“√º√´
		OLED_DrawEllipse(40,32,6,6-i,1);//◊Û—€
	...
	{
		OLED_Clear();
		OLED_ShowImage(30,12-i,16,16,Eyebrow[0]);//◊Û√º√´
		OLED_ShowImage(82,12-i,16,16,Eyebrow[1]);//”“√º√´
		OLED_DrawEllipse(40,32,6,4+i,1);//◊Û—€
